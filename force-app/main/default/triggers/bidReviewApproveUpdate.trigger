trigger bidReviewApproveUpdate  on bidReview__c (before update) {
if(trigger.new.size()>100){
      ...
      for(bidReview__c newCC:trigger.new){
              ...
              //主导事业部
              if(newCC.cpywdyfzr__c == null || newCC.MainProductGroup__c!= oldCC.MainProductGroup__c){
                ...
                //销售中心总经理                     
                  if((newCC.MainIndustrySales__c != null &&  newCC.SalesCenterManager__c == null) || (newCC.MainIndustrySales__c != oldCC.MainIndustrySales__c)) {
                      ...
                      if(newCC.FindApply__c != '未知' &&newCC.FindApply__c != '' && newCC.FindApply__c != null &&(!System.Test.isRunningTest())){
